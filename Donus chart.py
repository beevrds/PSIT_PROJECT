'''
Plot DONUT CHART : place of electricity (ENERGY SALES (GWh))
                   that you want to see in 2557-2558
...
print("----------------------------------")
print("choose 1  :  Resi dential")
print("choose 2  :  Small General Service")
print("choose 3  :  Medium General Service")
print("choose 4  :  Large General Service")
print("choose 5  :  Specific Business Service")
print("choose 6  :  Gov't Institutions & Non-Profit Organizations")
print("choose 7  :  Temporary Tariff")
print("choose 8  :  TOTAL")
print("choose 9  :  Public Lightings")
print("choose 10 :  TOTAL& Public Lightings")
print("----------------------------------")
...
if type_place == 1:
    ...
    name_title = "Resi dential Electricity 2557-2558"
elif type_place == 2:
    #data of Small General Service 2557
    ...
    #data of Small General Service 2558
    ...
    name_title = "Small General Service Electricity 2557-2558"
elif type_place == 3:
    #data of Medium General Service 2557
    ...
    #data of Medium General Service 2558
    ...
    name_title = "Medium General Service Electricity 2557-2558"
elif type_place == 4:
    #data of Large General Service 2557
    ...
    #data of Large General Service 2558
    ...
    name_title = "Large General Service Electricity 2557-2558"
elif type_place == 5:
    #data of Specific Business Service 2557
    ...
    #data of Specific Business Service 2558
    ...
    name_title = "Specific Business Service Electricity 2557-2558"
elif type_place == 6:
    #data of Gov't Institutions & Non-Profit Organizations 2557
    ...
    #data of Gov't Institutions & Non-Profit Organizations 2558
    ...
    name_title = "Gov't Institutions & Non-Profit Organizations Electricity 2557-2558"
elif type_place == 7:
    #data of Temporary Tariff Electric 2557
    ...
    #data of Temporary Tariff Electric 2558
    ...
    name_title = "Temporary Tariff Electricity 2557-2558"
elif type_place == 8:
    #data of TOTAL 2557
    ...
    name_title = "TOTAL Electricity 2557-2558"
elif type_place == 9:
    #data of Public Lightings 2557
    ...
    name_title = "Public Lightings Electricity 2557-2558"
elif type_place == 10:
    #data of TOTAL& Public Lightings 2557
    ...
    #data of TOTAL& Public Lightings 2558
    ...
    name_title = "TOTAL& Public Lightings Electricity 2557-2558"
